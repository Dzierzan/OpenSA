...
{
	public class VerticalSelectionDecorationsColonyInfo : SelectionDecorationsBaseInfo, Requires<InteractableInfo>
	{
		public override object Create(ActorInitializer init) { return new VerticalSelectionDecorationsColony(init.Self, this); }
	}

	public class VerticalSelectionDecorationsColony : SelectionDecorationsBase, IRender
	{
		readonly Interactable interactable;

		public VerticalSelectionDecorationsColony(Actor self, VerticalSelectionDecorationsColonyInfo info)
			: base(info)
		{
		...
		{
			var bounds = interactable.DecorationBounds(self, wr);
			yield return new CustomSelectionBoxAnnotationRenderableColony(self, bounds, color);
		}
		...
		protected override IEnumerable<IRenderable> RenderSelectionBars(Actor self, WorldRenderer wr, bool displayHealth, bool displayExtra)
		{
			...
			var bounds = interactable.DecorationBounds(self, wr);
			yield return new VerticalSelectionBarsAnnotationRenderableColony(self, bounds, displayHealth, displayExtra);
		}
