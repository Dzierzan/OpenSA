...
using OpenRA.Mods.OpenSA.EditorBrushes;
using OpenRA.Widgets;

namespace OpenRA.Mods.OpenSA.Widgets.Logic
{
	public class CustomTileSelectorLogic : CommonSelectorLogic
	{
		...
		public CustomTileSelectorLogic(Widget widget, ModData modData, World world, WorldRenderer worldRenderer)
		...
		protected override void InitializePreviews()
		{
			...
			foreach (var t in allTemplates)
			{
				...
				var item = ScrollItemWidget.Setup(ItemTemplate,
					...
					() => Editor.SetBrush(new CustomEditorTileBrush(Editor, tileId, WorldRenderer)));
