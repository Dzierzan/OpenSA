...
namespace OpenRA.Mods.Swarm_Assault.FileSystem
{
    public class DdfPackageLoader : IPackageLoader
    {
        ...
        {
            public UndisposingSegmentStream(Stream stream, long offset, long count) : base(stream, offset, count)
            {
            }
        ...
        public sealed class DdfSegmentStream : UndisposingSegmentStream
        {
            ...
            public DdfSegmentStream(Stream ddfStream, long ddfOffset, bool isTile) : base(ddfStream, 0, ddfStream.Length)
            {
        ...
        public sealed class DdfPackage : IReadOnlyPackage
        {
            ...
            public Stream GetStream(string filename)
            {
                ...
                if (filename.Equals("SWARM_ASSAULT.PAL"))
